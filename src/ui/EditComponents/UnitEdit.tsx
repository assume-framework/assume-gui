    ...
    return (
        <>
            ...
            {data.unitType === "power_plant" && (
                <>
                    <Input required label="Min Power" id="min_power" type="number" value={data.min_power} onChange={onChange("min_power")} />
            ...
            {data.unitType === "storage" && (
                <>
                    ...
                    <Input label="Min Power Charge" id="min_power_charge" type="number" value={data.min_power_charge} onChange={onChange("min_power_charge")} />
                    <Input label="Min Power Discharge" id="min_power_discharge" type="number" value={data.min_power_discharge} onChange={onChange("min_power_discharge")} />
                    <Input label="Min SOC" id="min_soc" type="number" value={data.min_soc} onChange={onChange("min_soc")} />
                    <Input label="Initial SOC" id="initial_soc" type="number" value={data.initial_soc} onChange={onChange("initial_soc")} />
                    <Input label="SOC Tick" id="soc_tick" type="number" value={data.soc_tick} onChange={onChange("soc_tick")} />
                </>
            )}
        </>
    )
