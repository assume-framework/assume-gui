...
export default ({ id, data, updateNodeValue }: EditComponentArgs) => {
    ...
    return (
        <>
            <Input label="Start Time" id="start" type="datetime-local" value={data.start} onChange={onChange("start")} />
            <Input label="End Time" id="end" type="datetime-local" value={data.end} onChange={onChange("end")} />
